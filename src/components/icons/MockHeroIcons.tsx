...
// This is a mock implementation of the heroicons components
// In a real project, you would install @heroicons/react
...
export const ChatBubbleLeftRightIcon = ({ className = '', ...props }: IconProps) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    fill="none" 
    viewBox="0 0 24 24" 
